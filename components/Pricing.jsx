...
const units = [
  {
    ...
    features: [
      "Best Launch Price – Limited Units",
  ...
  },
  {
    ...
    features: [
      "Grand Lobby with Triple-Height Ceiling",
      "ORR-Facing Views",
      "Premium Finishes",
    ],
    isPopular: true,
  },
  {
    ...
    btnText: "Ask For Price",
    features: [
      "Ultra-Spacious Luxury Residences",
      "Panoramic Greenery Views",
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          >
            Configuration &amp; <span style={{ color: 'var(--color-primary)' }}>Price</span>
          </h2>
