...
const categories = [
  {
    ...
    items: ['Birla Open Minds International School – 4 km', 'Samishti International School – 6 km', 'Gaudium School – 7 km'],
  },
  {
    label: 'Hospitals',
    ...
    items: ['Citizens Specialty Hospital – 8 km', 'AIG Hospitals, Gachibowli – 10 km', 'Continental Hospitals – 11 km'],
  },
  {
    label: 'Food & Shopping',
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="16" height="16"><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>,
    items: ['Sarath City Capital Mall – 12 km', 'Inorbit Mall, Hitech City – 14 km', 'SLN Terminus – 13 km'],
  },
  {
    label: 'Growth Drivers',
    icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" width="16" height="16"><rect x="2" y="3" width="20" height="14" rx="2" ry="2" /><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="17" x2="12" y2="21" /></svg>,
    items: ['Financial District – 9 km', 'Gachibowli IT Hub – 11 km', 'Neopolis, Kokapet – 8 km'],
  },
  {
    ...
    items: ['Outer Ring Road (ORR) – 5 km', 'Lingampally Railway Station – 12 km', 'Rajiv Gandhi International Airport – 28 km'],
  },
]
    ...
    <section id="location" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }} data-aos="fade-up">
          ...
          }}>ORR Exit 2, Kollur, Hyderabad</span>
          <h2 style={{
            fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
            color: '#111827', margin: '0 0 6px', letterSpacing: '-0.01em',
          }}>
            Location{' '}
            <span style={{ color: 'var(--color-primary)' }}>Advantages</span>
          </h2>
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-stretch">
          ...
          <div className="w-full lg:flex-1" data-aos="fade-left" style={{ minHeight: '420px' }}>
            <div style={{
              ...
              {/* Google Maps iframe */}
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3805.606616489346!2d78.24567287516705!3d17.47853268342437!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcbed003b9901ff%3A0x7335f10ec77272f9!2sPrestige%20Golden%20Grove!5e0!3m2!1sen!2sin!4v1776254952770!5m2!1sen!2sin"
                width="100%"
                height="100%"
              ...
              />
              {/* Image fallback commented out
              <Image
                src="/images/location/l-map.webp"
                alt="Prestige Golden Grove Location Map – ORR Exit 2, Kollur, Hyderabad"
                fill
