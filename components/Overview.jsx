'use client'
import React, { useEffect, useState } from 'react' // useState used in EarlyForm
...
const SHORT_TEXT = `Prestige Kollur represents Prestige Group's flagship residential vision in West Hyderabad—a comprehensive, self-contained, high-profile community offering thoughtfully planned homes and modern amenities that support a premium quality of life. Prestige The Golden Grove, an announced residential development by Prestige Group, is located at Tellapur, near Kollur, and is designed by renowned architect Hafeez Contractor. The project is envisioned as an integrated world in itself, featuring a curated mix of leisure, recreational, and service amenities, beautifully landscaped gardens and expansive lawns, broad and well-laid vehicle-free, tree-lined roads, thoughtfully designed social spaces and cultural arenas, along with sustainable management practices.`
    ...
    <section id="overview" className="!pt-1 !pb-4 sm:!py-10" style={{
      ...
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div style={{ textAlign: 'center', marginBottom: '36px' }} data-aos="fade-up">
          ...
          }}>Prestige Golden Grove</span>
          <h2 style={{
            fontFamily: F_JOST, fontWeight: '800', fontSize: '26px',
            color: '#111827', margin: 0, letterSpacing: '-0.01em',
          }}>
            Project <span style={{ color: 'var(--color-primary)' }}>Overview</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
          ...
          <div data-aos="fade-right" style={{ display: 'flex' }}>
            <div style={{
              ...
              <Image src={overviewImage} alt="Prestige Golden Grove" fill className="object-cover object-center"
