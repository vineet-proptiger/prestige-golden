        ...
        <div style={{
          ...
          <div style={{ padding: '24px 28px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <p className='text-justify' style={{ color: '#555', fontFamily: F_SANS, lineHeight: 1.85, fontSize: '14px', margin: '0 0 20px' }}>
              Prestige Group is one of India's leading real estate developers with over three decades of excellence, founded in 1986. Known for delivering landmark projects across Hyderabad, Bangalore, Chennai, and other major cities, Prestige has built thousands of homes with a strong focus on quality construction, timely delivery, and customer satisfaction.
            </p>
