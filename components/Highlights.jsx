...
import { Compass, TreePine, Building2, Diamond, Landmark, Briefcase } from 'lucide-react'
...
const highlights = [
  {
    text: 'Vaastu-compliant units',
    icon: <Compass {...highlightIconProps} />,
  },
  {
    text: 'Beautiful greenery & ORR-facing views',
    icon: <TreePine {...highlightIconProps} />,
  },
  {
    text: 'Grand lobbies with triple-height ceilings',
  ...
  {
    text: 'Resort-style lobbies & arrival experience',
    icon: <Landmark {...highlightIconProps} />,
  },
  {
    text: 'Easy access to major IT hubs',
    icon: <Briefcase {...highlightIconProps} />,
  },
]
    ...
    <div className="container mx-auto px-4 md:px-8">
      ...
      <div style={{ textAlign: 'center', marginBottom: '40px' }} data-aos="fade-up">
        ...
        <h2 style={{
          ...
          Project Highlights:{' '}
          <span style={{ color: 'var(--color-primary)' }}>Prestige Golden Grove</span>
        </h2>
